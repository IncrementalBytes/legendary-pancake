...
public class SignInActivity extends BaseActivity implements OnClickListener {
  ...
  private static final int RC_SIGN_IN = 4801;
    ...
    if (requestCode == RC_SIGN_IN) {
      ...
      if (result.isSuccess()) {
        ...
        if (account != null) {
          ...
          LogUtils.error(TAG, "Sign-in account was null.");
          Snackbar.make(findViewById(R.id.activity_sign_in), "Sign-in account was null.", Snackbar.LENGTH_SHORT).show();
        }
      } else {
  ...
  private void onAuthenticateSuccess(FirebaseUser user) {
    ...
    intent.putExtra(BaseActivity.ARG_USER_PHOTO, user.getPhotoUrl());
